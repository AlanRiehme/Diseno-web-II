...
<form class="" action="index.php" method="post">
  ...
  <button type="submit" class="btn btn-outline-dark" name="enviar">Enviar</button> <ahref="index.php"><a href="index.php" name="volver" class="btn btn-outline-dark">Volver</a>
  <form class="" action="index.php" method="post">
