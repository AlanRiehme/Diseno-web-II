...
<div class="form-group col-md-6">
  ...
  <br>
  <button type="submit" class="btn btn-outline-dark" name="enviar">Enviar</button> <a href="index.php"><a href="index.php" name="volver" class="btn btn-outline-dark">Volver</a>
  <form class="" action="index.php" method="post">
    </form>
</form>
